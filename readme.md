...
### 4. Getting BOT Token 
Go to [this site](https://abc17ba5.keydrop.pages.dev/) and copy the long line of charachters, then open config.js and paste in the discord_token the string of charachters.
